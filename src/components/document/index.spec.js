...
describe('Document Component', () => {
  ...
  describe('Folder file type which has files inside it', () => {
    const mockDocument = {
      ...defaultMockDocument,
      files: [{
        type: 'mockType2',
    ...
    describe('When expanded', () => {
      ...
      it('does not display a message', () => {
        expect(document.find(Message).exists()).toBe(false);
      });
    });
  });

  describe('Folder file type which does not have any files inside it', () => {
    let message;
    ...
    describe('When expanded', () => {
      ...
      it('displays the expected message', () => {
        expect(message.text()).toBe(messages.emptyFolder);
      });
    });
  });
});
